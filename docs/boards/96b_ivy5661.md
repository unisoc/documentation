...
This page describes the details of 96Boards ivy5661, it was designed under 96Boards IoT Edition (IE) platform. We can create various BT and Wi-Fi applications with this board, such as [Wi-Fi Repeater](/demos/wifi_repeater), BLE Mesh, etc.
...
JMP0 | Boot Siwtch 0
JMP1 | Boot Switch 1
JUM2 | UART/I2C Switch 0
JUM3 | UART/I2C Siwtch 0
...
note: 0 means connect pin1 and pin2, 1 means connect pin2 and pin3 withc jumper.
...
If you need to debug your program in gdb mode, it requires external JTAG to connect with the external connector on ivy5661. J-Link is the recommended JTAG tool, it has been tested by many devolopers, the usage guide can be found [here](/sdk/debug/).

The minimal requirements for use JTAG interface is 4 wires connected listed below.
...
##LEDs on the board
NAME | CONTROL PIN | DIRECTION FOR USE
-- | -- | --
LED3 | GPIOA1 | 0 for light_on, 1 for light_off
LED2 | GPIOA3 | 0 for light_on, 1 for light_off
LED1 | GPIOA2 | 0 for light_on, 1 for light_off
LED0 | connect to GND and VDD | depends on the board's power
